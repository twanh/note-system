...
class Config:
    ...
    def __init__(
        ...
        self.conf_file_location = config_file_locations
        ...
        self.OPTIONS = {
            ...
            'check': {
                ...
                'fix': {
                    ...
                    'help': 'enables auto fixing for problems in the documents',  # noqa: E501
                    'action': 'store_true',
                    'type': bool,
                    'default': False,
                },
                'disabled_errors': [
                    self._create_option_disabled_error(error)  # type: ignore
